...
const LINE_NOTIFY_TOKEN = PropertiesService.getScriptProperties().getProperty('LINE_WHEATHER_CHECK');
// QiitaのスプレッドシートのID
const SSID_QIITA_VIEW = '1_tZxSWDgIxCBwNL_ApwxJqx3Qju6EzbkeumvBrXprl8';
// Qiitaのスプレッドシートのシート名
const SSN_QIITA_VIEW = 'QiitaVIEW';
// Qiitaトークン
const QIITA_TOKEN = PropertiesService.getScriptProperties().getProperty('QIITA_ACCESS_TOKEN'); 
// 記事タイトル最大長
